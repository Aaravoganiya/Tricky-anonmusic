...
async def help(client: Client, message: Message):
    ...
    await message.reply_sticker("CAACAgUAAx0CYnXmFwACAvdiqEnbzyNmvAmX1a8kp9Yw31L1rAACzwMAAgU96VXI3sXvdotmCB4E")
    rahul = await message.reply_photo(
        photo=f"{PING_IMG}",
        caption="ᴩɪɴɢɪɴɢ...",
    )
    await rahul.edit_text(
        f"""<b> ᴀᴀʀᴀᴠ ʟᴏᴠᴇ ʙᴀʀʙɪᴇ 💖😘  !</b>\n  🏓 `{resp} ᴍs`\n\n<b><u>{BOT_NAME} sʏsᴛᴇᴍ sᴛᴀᴛs:</u></b>\n\n• ᴜᴩᴛɪᴍᴇ : {bot_uptime}\n• ᴄᴩᴜ : {cpu}%\n• ᴅɪsᴋ : {disk}%\n• ʀᴀᴍ : {mem}""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💖 ʟᴏᴠᴇ ", url="https://t.me/AARAV143BARBIE"
                    ),
                    InlineKeyboardButton(
                        "💖 ʟᴏᴠᴇ ", url="https://t.me/AARAV143BARBIE"
                    )
